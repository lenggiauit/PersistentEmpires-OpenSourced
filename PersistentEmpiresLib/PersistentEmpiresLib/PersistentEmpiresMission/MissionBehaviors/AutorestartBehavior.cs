...
namespace PersistentEmpiresLib.PersistentEmpiresMission.MissionBehaviors
{
    public class AutorestartBehavior : MissionLogic
    {
        ...
        public override void OnMissionTick(float dt)
        {
            ...
            {
                InformationComponent.Instance.BroadcastAnnouncement("Server will be restarted in 5 minutes.");
            ...
            {
                InformationComponent.Instance.BroadcastAnnouncement("Server will be restarted in 1 minutes.");
            ...
            {
                InformationComponent.Instance.BroadcastAnnouncement("Server will be restarted in 10 seconds.");
