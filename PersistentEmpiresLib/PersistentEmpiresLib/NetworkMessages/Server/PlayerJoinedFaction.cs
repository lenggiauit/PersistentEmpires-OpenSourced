...
namespace PersistentEmpiresLib.NetworkMessages.Server
{
    ...
    public sealed class PlayerJoinedFaction : GameNetworkMessage
    {
        ...
        protected override bool OnRead()
        {
            ...
            this.joinedFrom = GameNetworkMessage.ReadIntFromPacket(new CompressionInfo.Integer(-1, 300, true), ref result);
        ...
        protected override void OnWrite()
        {
            ...
            GameNetworkMessage.WriteIntToPacket(joinedFrom, new CompressionInfo.Integer(-1, 300, true));
